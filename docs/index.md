...
- [Shortlink Index](indexes/shortlinks.md) — all designs with A360 links (369 total)
- [BOM / Uses Index](indexes/bom-uses.md) — assemblies with component references (75 total)
- [Migration Candidates](indexes/migration-candidates.md) — designs flagged for potential relocation to `00 - Parts` (160 total)
...
- **[A-9999 Lab](designs/a-9999-lab/000003-manifold-iair3-type-i-w1.md)** — Lab project designs (38 designs)
    ...
    - [GEGENEES](designs/a-9999-lab/gegenees/6-dut-assem.md) — GEGENEES test fixture designs (18 designs, 4 OTS migration candidates)
        - [Sterling CAN Controller](designs/a-9999-lab/gegenees/sterling-can-controller/sterling-6-dut-controller.md) — Sterling CAN Controller designs (1 design)
